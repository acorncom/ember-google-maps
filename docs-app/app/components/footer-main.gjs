<template>
  <footer>
    © 2017-2024
    <a href="https://github.com/sandydoo">Sander Melnikov</a>, 2024-present
    <a href="https://github.com/acorncom">David Baker</a>
    <br />
    Licensed under
    <a
      href="https://github.com/acorncom/ember-google-maps/blob/main/LICENSE"
    >MIT</a>.
    <br />
    Follow the addon on
