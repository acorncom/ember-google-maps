...
// AI-derived from google.maps.Polyline's documented events and hand-maintained
// (verify against Google's docs before trusting). Path mouse events carry a
// PolyMouseEvent; drag events carry a plain MapMouseEvent.
export type PolylineEvents = MapEvents<
...
export interface PolylineSignature {
  Args: google.maps.PolylineOptions & PolylineEvents;
  Blocks: { default: [] };
  Element: null;
}
